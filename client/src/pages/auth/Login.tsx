      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-[var(--color-champagne)] hover:text-[var(--color-champagne-dark)] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input 
          ...
          <p className="mt-8 text-center text-sm text-[var(--color-stone)] font-[var(--font-body)]">
            ...
            <Link to="/register" className="text-[var(--color-charcoal)] font-medium hover:text-[var(--color-champagne-dark)] transition-colors">
              Request access
            </Link>
          </p>
        </motion.div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-[var(--color-charcoal)]">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <div className="glass-premium-dark p-8 rounded-2xl border border-white/10">
            <h3 className="text-2xl font-[var(--font-display)] mb-2">"The gold standard for portfolio management."</h3>
            <p className="text-white/60 text-sm font-[var(--font-body)]">— Vogue Architecture</p>
          </div>
        </div>
      </div>
