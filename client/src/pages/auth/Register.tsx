  ...
  return (
    <div className="min-h-screen flex flex-row-reverse bg-[var(--color-ivory)]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative">
        <Link to="/" className="absolute top-8 right-8 flex items-center gap-3 group">
          <span className="font-medium tracking-tight text-[var(--color-charcoal)]" style={{ fontFamily: 'var(--font-display)' }}>
          ...
          <div className="w-8 h-8 rounded-full bg-[var(--color-charcoal)] flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
            <span className="text-white text-xs font-semibold tracking-widest">E</span>
          </div>
        </Link>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest text-[var(--color-stone)] font-medium">Full Name</label>
              <input 
                type="text"
                required
                value={name}
            ...
            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest text-[var(--color-stone)] font-medium">Email Address</label>
              <input 
                type="email"
                required
                value={email}
            ...
            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest text-[var(--color-stone)] font-medium">Password</label>
              <input 
                type="password"
                required
                value={password}
            ...
            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest text-[var(--color-stone)] font-medium">Account Type</label>
              <select 
                value={role}
          ...
          <p className="mt-8 text-center text-sm text-[var(--color-stone)] font-[var(--font-body)]">
            Already a member?{' '}
            <Link to="/login" className="text-[var(--color-charcoal)] font-medium hover:text-[var(--color-champagne-dark)] transition-colors">
              Sign in
            </Link>
          </p>
        </motion.div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-[var(--color-charcoal)]">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <div className="glass-premium-dark p-8 rounded-2xl border border-white/10">
            <h3 className="text-2xl font-[var(--font-display)] mb-2">"An architectural triumph in software design."</h3>
            <p className="text-white/60 text-sm font-[var(--font-body)]">— Modern House</p>
          </div>
        </div>
      </div>
